...
public class AeEngineAlert extends AeEvent implements IAeEngineAlert {
	 ...
	 * 
	 * @param aProcessID
	 *            id of the process that generated the alert
	 * @param aEventID
	 *            type of alert
	 * @param aProcessName
	 *            qname of the process that generated the alert
	 * @param aLocation
	 *            location of the activity within the process that generated the
	 *            alert
	 * @param aFaultName
	 *            optional qname of the fault
	 * @param aDetails
	 *            option details related to the alert - possibly variable data
	 */
	 ...
	 *            option details related to the alert - possibly variable data
	 * @param aTimestamp
	 *            the timestamp of the event/alert
	 */
	public AeEngineAlert(long aProcessID, AeEngineAlertEventType aEventID,
			QName aProcessName, String aLocation, QName aFaultName,
