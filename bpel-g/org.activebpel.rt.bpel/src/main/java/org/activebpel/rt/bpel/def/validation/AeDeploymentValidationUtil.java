...
public class AeDeploymentValidationUtil {
     ...
     *
     * @param aVar           The variable used in query.
     * @param aPart          The part of the message/variable used in query.
     * @param aQuery         The query to validate.
     * @param aPath          the variable path.
     * @param aErrorReporter Reporter to which validation errors are to be added.
     */
     ...
     * @param aQuery               The query to validate.
     * @param aPath                the variable path
     * @param aContextWSDLProvider Context wsdl provider
     * @param aErrorReporter       Reporter to which validation errors are to be added.
     */
