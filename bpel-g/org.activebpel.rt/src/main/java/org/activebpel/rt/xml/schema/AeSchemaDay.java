...
public class AeSchemaDay extends AeAbstractTZBasedSchemaType
{
   ...
   private static final Pattern INPUT_PATTERN = Pattern.compile("---([0-9]{2})(Z|(([+-])([0-9]{2}):([0-9]{2})))?"); //$NON-NLS-1$
   /** The output pattern. */
   private static final String OUTPUT_PATTERN = "---{0,number,00}{1}"; //$NON-NLS-1$
