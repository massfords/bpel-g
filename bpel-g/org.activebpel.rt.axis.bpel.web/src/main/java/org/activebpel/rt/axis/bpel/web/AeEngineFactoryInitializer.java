...
public class AeEngineFactoryInitializer implements ServletContextListener {
     ...
     *
     * @param aContext
     * @throws AeException Thrown if there is no corresponding environment property for
     ...
     *
     * @param aServletHome Any files that are not absolute will be resolved relative to
     *                     this file.
