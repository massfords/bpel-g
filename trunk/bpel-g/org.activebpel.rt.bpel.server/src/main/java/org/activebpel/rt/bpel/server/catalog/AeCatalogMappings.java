...
public class AeCatalogMappings {
	 ...
	 * 
	 * @param aBpr
	 *            The Bpr containing the catalog.
	 * @throws AeException
	 */
	 ...
	 * @param aBpr
	 *            The Bpr containing the catalog.
	 * @param aReplaceExistingResource
	 *            the flag to use for replace existing resources.
	 * @throws AeException
	 */
	 ...
	 * 
	 * @param aEntries
	 * @param aDefaultTypeURI
	 *            the default type uri or null if one must be in element
	 */
