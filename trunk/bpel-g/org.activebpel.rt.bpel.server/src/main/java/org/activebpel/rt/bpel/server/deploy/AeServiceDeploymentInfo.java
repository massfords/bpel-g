...
public class AeServiceDeploymentInfo implements IAeServiceDeploymentInfo {
	 ...
	 * @param aPolicyList
	 */
	public AeServiceDeploymentInfo(String aServiceName,
			AePartnerLinkDefKey aPartnerLinkDefKey, MyRoleBindingType aBinding,
			String aRoles, List aPolicyList) {
