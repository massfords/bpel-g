...
<%@ include file="incl_processview_graph_declaration.jsp" %>
   <head>
      ...
      <script type="text/javascript" language="JavaScript">
         ...
         nCols = 0;
         nRows = 0;
         processImageUriBase = "../processview/<%-- ASP_Conversion_Start:Substitute graphimage.aspx?--%>graphimage?<%-- ASP_Conversion_Stop --%><ae:GetProperty name="graphBean" property="pidParamName" />=<ae:GetProperty name="graphBean" property="pidParamValue" />&part=<ae:GetProperty name="graphBean" property="partId" />";         
