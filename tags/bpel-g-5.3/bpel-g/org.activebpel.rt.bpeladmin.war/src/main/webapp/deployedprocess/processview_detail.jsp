...
<%@ include file="incl_processview_detail_declaration.jsp" %>
   ...
   <frameset rows="50px,*,30px" frameborder="yes" framespacing="1" border="1">
      ...
      <frameset cols="25%,*" frameborder="yes" framespacing="2" border="2">
         <frame src="processview_outline.jsp?<ae:GetProperty name="processViewBean" property="pidParamName" />=<ae:GetProperty name="processViewBean" property="pidParamValue" />" name="pvoutline" id="pvoutline" />
         <ae:IfTrue name="processViewBean" property="graphingEnabled" >
            <frameset rows="70%,*" frameborder="yes" framespacing="2" border="2">
               <frame src="processview_graph.jsp?<ae:GetProperty name="processViewBean" property="pidParamName" />=<ae:GetProperty name="processViewBean" property="pidParamValue" />&part=0&t=<%= System.currentTimeMillis() %>" name="pvgraph" id="pvgraph" />
